...
const ySlider = document.getElementById('yPosition') as HTMLInputElement;						console.log("picked up y value slider"); console.log(ySlider);
...
const zSlider = document.getElementById('zPosition') as HTMLInputElement;						console.log("picked up z value slider"); console.log(zSlider);
...
const deskTop = document.getElementById("canvas") as HTMLInputElement;
...
const skyBoxLoader = document.getElementById("skybox") as HTMLInputElement;
